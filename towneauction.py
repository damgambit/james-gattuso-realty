...
def parser(self):
    ...
    for bot in both:
        ...
        t = TownAuction.objects.get_or_create(
                            date=datetime.datetime.strptime(texts[0], '%m/%d/%y'),
                            time=texts[1],
                            status=texts[2],
                            address=texts[3],
                            city=texts[4],
...
def get_page_response():
    ...
    r = s.get('http://www3.towneauction.com/Auctions_NoNav.aspx',
    ...
    while i < int(last_page):
        ...
        r1 = s.post('http://www3.towneauction.com/Auctions_NoNav.aspx',headers={'User-Agent':'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36'},
